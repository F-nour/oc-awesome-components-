...
import {slideAndFadeAnimation} from "../../animations/slide.animation";
...
export class CommentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    for (let index in this.comments) this.animationStates[index] = 'default';
  }
  ...
  onListItemActive(index: number) {
    this.animationStates[index] = 'active';
  }

  onListItemDefault(index: number) {
